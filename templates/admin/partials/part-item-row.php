<?php
/**
 * Cart breakdown part item row (variants inside one part).
 *
...
<div class="kcp-repeater__row kcp-repeater__row--option-item">
	<label>
		...
		<input
			type="text"
			name="kcp_preset[part_groups][<?php echo esc_attr( (string) $group_index ); ?>][items][<?php echo esc_attr( (string) $item_index ); ?>][id]"
	...
	<label>
		...
		<input
			type="text"
			name="kcp_preset[part_groups][<?php echo esc_attr( (string) $group_index ); ?>][items][<?php echo esc_attr( (string) $item_index ); ?>][value]"
			value="<?php echo esc_attr( (string) ( $item['value'] ?? $item['label'] ?? '' ) ); ?>"
			class="regular-text"
	...
	<label>
		...
		<input
			type="number"
			step="0.01"
			name="kcp_preset[part_groups][<?php echo esc_attr( (string) $group_index ); ?>][items][<?php echo esc_attr( (string) $item_index ); ?>][price]"
	...
	<label class="kcp-repeater__full">
		...
		<input
			type="text"
			name="kcp_preset[part_groups][<?php echo esc_attr( (string) $group_index ); ?>][items][<?php echo esc_attr( (string) $item_index ); ?>][description]"
	...
	<div class="kcp-repeater__full kcp-repeater__image-field">
		...
		<?php
		$name     = 'kcp_preset[part_groups][' . (string) $group_index . '][items][' . (string) $item_index . '][image_url]';
	...
	<button type="button" class="button kcp-repeater__remove" aria-label="<?php esc_attr_e( 'Remove part item', 'kitchen-configurator-pro' ); ?>">&times;</button>
</div>
